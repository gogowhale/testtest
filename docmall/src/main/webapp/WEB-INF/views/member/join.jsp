	...
	<form>
	  <div class="form-group row">
	    <label for="staticEmail" class="col-sm-2 col-form-label">아이디</label>
		    <div class="col-sm-5">
		      <input type="text" class="form-control" id="staticEmail" placeholder="아이디를 8-15 이내로 입력">
		    </div>
		    <div class="col-sm-2">
		      <button type="button" class="btn btn-secondary">ID중복체크</button>
		    </div>	
		    <label for="staticEmail" class="col-sm-3 col-form-label">중복체크결과</label>    
	  </div>
	  <div class="form-group row">
	  ...
	  <div class="form-group row">
	   ...
	   <div class="form-group row">
	       	<label class="form-check-label col-sm2" for="defaultCheck1"> 메일수신동의 </label>
	 		<div class="col-sm-10">
